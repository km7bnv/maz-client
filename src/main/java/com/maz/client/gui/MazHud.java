...
public class MazHud {
    ...
    private static void refreshFastText(Minecraft client) {
        ...
        if (enabled(coordinatesModule)) {
            ...
            coordinatesText = "XYZ: " + x + " / " + y + " / " + z + " | Chunk: " + Math.floorDiv(x, 16) + " / " + Math.floorDiv(z, 16) + " | Local: " + Math.floorMod(x, 16) + " / " + Math.floorMod(z, 16);
        }
